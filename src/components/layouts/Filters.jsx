  ...
  return (
    <aside className="md:w-1/3 lg:w-1/4 px-4">
      ...
      <div className="hidden md:block px-6 py-4 border border-gray-200 bg-white rounded shadow-sm">
        ...
        >
          <Checkbox value="buenos-aires">Electronics</Checkbox>
          <Checkbox value="sydney">Laptops</Checkbox>
          <Checkbox value="san-francisco">Toys</Checkbox>
          <Checkbox value="london">Office</Checkbox>
          <Checkbox value="tokyo">Beauty</Checkbox>
        </CheckboxGroup>
